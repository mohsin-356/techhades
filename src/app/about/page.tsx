...
export default function AboutPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      <h1 className="text-3xl sm:text-5xl font-[family:var(--font-display)]">About Us</h1>
      <p className="mt-4 text-zinc-400 max-w-2xl">
        We are a group of elite engineers and designers delivering premium digital products.
      </p>

      <h2 className="mt-12 text-xl sm:text-2xl text-white">Our Story</h2>
      <ol className="relative border-l border-white/10 mt-6 space-y-6">
        {timeline.map((t) => (
      ...
      <h2 className="mt-12 text-xl sm:text-2xl text-white">Team</h2>
